...
Rubylike.Array = require('./rubylike_array.js').Rubylike.Array;
Rubylike.Hash = require('./rubylike_hash.js').Rubylike.Hash;
Rubylike.String = require('./rubylike_string.js').Rubylike.String;
